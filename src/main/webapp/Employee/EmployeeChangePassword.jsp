    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar" id="sidebar">
            <div class="sidebar-header">
                <img src="/ELMS_3.0/imnsb_logo.png" alt="IMNSB Logo" class="sidebar-logo">
                <h3>IMNSB</h3>
            </div>
            <ul class="sidebar-menu">
                <li>
                    <a href="/ELMS_3.0/Employee/EmployeeDashboard.jsp"><i class="fas fa-user"></i> Profile</a>
                </li>
                <li>
                    <a href="/ELMS_3.0/LeaveApplicationController"><i class="fas fa-calendar-plus"></i> Apply Leave</a>
                </li>
                <li>
                    <a href="<%= request.getContextPath() %>/leave-history"><i class="fas fa-history"></i> Leave History</a>
                </li>
                <li class="active">
                    <a href="/ELMS_3.0/Employee/EmployeeSettings.jsp"><i class="fas fa-cog"></i> Settings</a>
                </li>
                <li class="logout">
        ...
        <main class="main-content" id="mainContent">
            <header class="content-header">
                ...
                <div class="header-right">
                    <span id="userName"><%= employee.getEmployeeName() != null ? employee.getEmployeeName() : "User" %></span>
            ...
            <div class="content-body">
                <div class="settings-container">
                    <div class="settings-form-card">
                        ...
                        <form id="changePasswordForm" action="/ELMS_3.0/employeeChangePassword" method="post">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch('/ELMS_3.0/employeeChangePassword', {
                    method: 'POST',
                    headers: {
               ...
               .then(data => {
				    ...
				    if (data.success) {
				        ...
				        if (data.redirect) {
				            ...
				            window.location.href = '/ELMS_3.0/Employee/EmployeeSettings.jsp';
				        }
