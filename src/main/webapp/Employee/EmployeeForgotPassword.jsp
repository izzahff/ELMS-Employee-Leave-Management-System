...
<title>Forgot Password - IMNSB Employee Leave Management System</title>
...
<body>
		...
		<div class="auth-card">
			<div class="logo-container">
				...
				<div class="logo-text">
					...
					<p>Employee Password Recovery</p>
				</div>
			</div>
			...
			<div class="auth-form">
				...
				<div class="auth-links">
					<a href="/ELMS_3.0/Employee/EmployeeLogin.jsp" class="auth-link">← Back to Login</a>
				</div>
				...
				<div id="email-form" class="step-form">
					...
					<form action="/ELMS_3.0/ForgotPasswordController" method="post" id="emailForm">
				...
				<div id="otp-form" class="step-form" style="display: none;">
					...
					<form action="/ELMS_3.0/ForgotPasswordController" method="post" id="otpForm">
				...
				<div id="password-form" class="step-form" style="display: none;">
					...
					<form action="/ELMS_3.0/ForgotPasswordController" method="post" id="passwordForm">
	...
	/* Base message styling from original */
	.error-message {
	    background: #ffe6e6;
	    color: #d63031;
	    padding: 15px;
	...
	function showStep(stepNumber) {
	    ...
	    document.getElementById(forms[stepNumber - 1]).style.display = 'block';
	    
	    // Update form title
	    const titles = ['Forgot Password', 'Verify OTP', 'Create New Password'];
	    document.getElementById('form-title').textContent = titles[stepNumber - 1];
	}
	...
	document.addEventListener('DOMContentLoaded', function() {
	    ...
	    if (step === '2' && email) {
	        ...
	        showStep(3);
	        document.getElementById('hidden-email-2').value = email;
	    }
	    ...
	    if (resendButton) {
	        resendButton.addEventListener('click', function() {
	            ...
	            if (email) {
	                ...
	                window.location.href = '/ELMS_3.0/ForgotPasswordController?action=resendOTP&email=' + encodeURIComponent(email);
	            }
	        });
	    }
	});
