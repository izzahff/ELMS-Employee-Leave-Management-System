...
<%
    ...
    if (adminPhone == null) adminPhone = "+60 ";
...
<body>
            ...
            <div class="content-body">
                <div class="settings-container">
                    ...
                    <div class="settings-form-card">
                        <form id="editAccountForm" action="/ELMS_3.0/update-admin-account" method="post" enctype="multipart/form-data">
                            
                            <!-- Profile Picture Section with Inline Preview -->
                            <div class="profile-picture-section">
						    <div class="profile-picture" id="profilePictureContainer">
						        <% 
						            String profilePicPath = adminProfilePicPath;
    ...
    <div id="profileStatus" style="margin-top: 10px; font-size: 12px; color: #666; text-align: center; min-height: 20px;"></div>
                            ...
                            <div class="form-group">
							    ...
							    <input type="text" id="fullName" name="adminname" value="<%= adminName != null ? adminName : "" %>" required>
							    <div class="form-error" id="nameError"></div>
							</div>
                            
                          <div class="form-group">
							    <label for="email">Email Address</label>
							    <input type="email" id="email" name="adminemail" value="<%= adminEmail != null ? adminEmail : "" %>" required>
							    <div class="form-error" id="emailError"></div>
							</div>
                            
                            <div class="form-group">
							    <label for="phone">Mobile Number</label>
							    <input type="tel" id="phone" name="adminphone" 
							           value="<%= adminPhone != null ? adminPhone : "+60 " %>" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="role" name="adminrole" value="System Administrator" 
                                ...
                                <small style="color: #666; font-size: 0.875rem; margin-top: 0.25rem; display: block;">
                                    Role cannot be changed. Contact system administrator if changes are needed.
                                </small>
                            </div>
            
                            <div class="form-buttons">
                                <a href="/ELMS_3.0/Admin/AdminSettings.jsp" class="btn btn-secondary">Cancel</a>
...
function handleProfilePictureChange(input) {
    console.log('🔥 ADMIN PROFILE PICTURE CHANGE HANDLER CALLED!');
    ...
    reader.onload = function(e) {
        ...
        console.log('🎉 Admin profile picture preview complete!');
    };
...
function removeProfilePicture() {
    console.log('🗑️ ADMIN REMOVE PROFILE PICTURE CALLED!');
    ...
    console.log('🎉 Admin profile picture removal complete!');
}
...
// Enhanced logout confirmation for Admin
...
//===== VALIDATION CODE FOR ADMIN EDIT ACCOUNT =====
...
phoneInput.addEventListener('input', function(e) {
    ...
    console.log('✅ Admin account validation loaded');
