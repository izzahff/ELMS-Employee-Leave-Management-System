...
<head>
    ...
    <title>Admin Login - IMNSB Employee Leave Management System</title>
    ...
    <div class="container">
        <div class="auth-card">
            ...
            <div class="auth-form">
                ...
                <!-- Login Form -->
                <form id="loginForm" method="post" action="/ELMS_3.0/AdminLoginController">
                    <div class="form-group">
                        <input type="text" 
                               id="adminId" 
                               name="adminId" 
                               placeholder="Admin ID or Email" 
                               value="<%= request.getAttribute("adminId") != null ? request.getAttribute("adminId") : "" %>"
                               required>
                    </div>
                    ...
                    <div class="form-group forgot-password">
                        <a href="/ELMS_3.0/Admin/AdminForgotPassword.jsp" class="forgot-link">Forgot Password?</a>
                    </div>
                    <div class="form-group">
