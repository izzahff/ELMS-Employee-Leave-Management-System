...
<head>
    <meta charset="UTF-8">
    <title>Manager Profile - IMNSB Employee Leave Management System</title>
...
<div class="dashboard-container">
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="active"><a href="ManagerDashboard.jsp"><i class="fas fa-user"></i> <span>Profile</span></a></li>
    ...
    <main class="main-content" id="mainContent">
        ...
        <div class="content-body">
            ...
            <div class="recent-applications">
                ...
                <p>Use the navigation menu to access different sections of the manager portal. You can review pending leave applications and view all submitted applications from the sidebar.</p>
            </div>
        </div>
    </main>
</div>
