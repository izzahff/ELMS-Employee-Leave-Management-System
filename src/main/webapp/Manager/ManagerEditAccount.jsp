            ...
            <div class="content-body">
                <div class="settings-container">
                    ...
                    <div class="settings-form-card">
                        <form id="editAccountForm" action="/ELMS_3.0/update-manager-account" method="post" enctype="multipart/form-data">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-buttons">
                                <a href="/ELMS_3.0/Manager/ManagerSettings.jsp" class="btn btn-secondary">Cancel</a>
...
function handleProfilePictureChange(input) {
    console.log('🔥 MANAGER PROFILE PICTURE CHANGE HANDLER CALLED!');
    ...
    reader.onload = function(e) {
        ...
        console.log('🎉 Manager profile picture preview complete!');
    };
...
function removeProfilePicture() {
    console.log('🗑️ MANAGER REMOVE PROFILE PICTURE CALLED!');
    ...
    console.log('🎉 Manager profile picture removal complete!');
}

// Enhanced logout confirmation for Manager
...
//===== VALIDATION CODE FOR MANAGER EDIT ACCOUNT =====
...
phoneInput.addEventListener('input', function(e) {
    ...
    console.log('✅ Manager account validation loaded');
