    ...
    if ("POST".equals(request.getMethod())) {
        ...
        if (password != null && confirmDelete != null) {
            ...
            if (passwordValid) {
                ...
                try {
                    boolean deleted = deleteManagerAccount(manager.getManagerid());
                    if (deleted) {
                    ...
                    System.err.println("Error deleting manager account: " + e.getMessage());
...
<%!
    ...
    // Helper method to delete manager account
    private boolean deleteManagerAccount(String managerId) {
        Connection conn = null;
        PreparedStatement pstmt = null;
        ...
        try {
            ...
            System.out.println("🔄 Starting deletion process for manager ID: " + managerId);
            
            // Start transaction
            conn.setAutoCommit(false);
            
            // Step 1: Check if manager has any leave applications
            ...
            System.out.println("📊 Found " + leaveAppCount + " leave applications for this manager");
            ...
            // Step 2: No employee table updates needed (no managerid column in employee table)
            ...
            System.out.println("🔄 Attempting to delete manager record...");
    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar" id="sidebar">
            <div class="sidebar-header">
                ...
                <h3>IMNSB Manager</h3><br>
            </div>
            <ul class="sidebar-menu">
                <li><a href="ManagerDashboard.jsp"><i class="fas fa-user"></i> <span>Profile</span></a></li>
                ...
                <div class="settings-container">
                    <div class="settings-form-card danger">
                        <div class="delete-warning">
                            ...
                            <p>Deleting your manager account will permanently remove all your data, including:</p>
                            <ul>
                                <li>Personal information and profile</li>
                                <li>All leave application approvals and history</li>
                                <li>Manager-specific records and permissions</li>
                        ...
                        <!-- ADD THIS HTML HERE - Right after the Java code and before the form -->
                        ...
                        <form id="deleteAccountForm" method="POST" action="">
                            ...
                            <div class="form-group">
                                <label class="checkbox-label">
                                    ...
                                    I understand that this action is permanent and cannot be undone. I want to permanently delete my manager account and all associated data.
                                </label>
                            </div>
                            
                            <div class="form-buttons">
                                <a href="/ELMS_3.0/Manager/ManagerSettings.jsp" class="btn btn-secondary">Cancel
                                </a>
        ...
        <div class="popup-body">
            <div style="text-align: center; padding: 1rem 0;">
                ...
                <p style="color: #495057; font-size: 1rem; margin: 0 0 1rem 0; line-height: 1.5;">
                    Are you absolutely sure you want to delete your manager account?
                </p>
                ...
                <div class="consequences-list">
                    ...
                    <ul>
                        ...
                        <li>Revoke access to the manager portal</li>
                        <li>Remove all manager-specific permissions</li>
