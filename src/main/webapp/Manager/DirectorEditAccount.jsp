            ...
            <div class="content-body">
                <div class="settings-container">
                    ...
                    <div class="settings-form-card">
                        <form id="editAccountForm" action="/ELMS_3.0/update-director-account" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
							    ...
							    <input type="text" id="fullName" name="managername" value="<%= manager.getManagername() != null ? manager.getManagername() : "" %>" required>
							    <div class="form-error" id="nameError"></div>
							</div>
                            
                            <div class="form-group">
							    <label for="email">Email Address</label>
							    <input type="email" id="email" name="manageremail" value="<%= manager.getManageremail() != null ? manager.getManageremail() : "" %>" required>
							    <div class="form-error" id="emailError"></div>
							</div>
                            
                            <div class="form-group">
							    <label for="phone">Mobile Number</label>
							    <input type="tel" id="phone" name="managernophone" 
							           value="<%= manager.getManagernophone() != null ? manager.getManagernophone() : "+60 " %>" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="position" name="managerposition" value="<%= manager.getManagerposition() != null ? manager.getManagerposition() : "" %>" 
                                ...
                                <small style="color: #666; font-size: 0.875rem; margin-top: 0.25rem; display: block;">
                                    Position cannot be changed. Contact system administrator if changes are needed.
                                </small>
                            </div>
...
function handleProfilePictureChange(input) {
    console.log('🔥 DIRECTOR PROFILE PICTURE CHANGE HANDLER CALLED!');
    ...
    reader.onload = function(e) {
        ...
        // Update status
        if (status) {
            status.innerHTML = '✅ Preview updated! Click "Save Changes" to apply permanently.';
            status.style.color = '#28a745';
            status.style.fontWeight = 'bold';
        }
        
        console.log('🎉 Director profile picture preview complete!');
    };
...
function removeProfilePicture() {
    console.log('🗑️ DIRECTOR REMOVE PROFILE PICTURE CALLED!');
    ...
    console.log('🎉 Director profile picture removal complete!');
}
...
// Enhanced logout confirmation for Executive Director
...
if (logoutBtn) {
    logoutBtn.addEventListener('click', function(e) {
        ...
        console.log('Executive Director logout initiated');
        return true;
    });
}
...
//===== VALIDATION CODE FOR EXECUTIVE DIRECTOR EDIT ACCOUNT =====
...
phoneInput.addEventListener('input', function(e) {
    ...
    console.log('✅ Executive Director account validation loaded');
