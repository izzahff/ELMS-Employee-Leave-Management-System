...
<head>
    ...
    <style>
        ...
        /* Additional styling for better consistency with manager dashboard */
        body {
            ...
            <div class="content-body">
                <div class="settings-container">
                    <div class="settings-form-card">
                        ...
                        <form id="changePasswordForm" action="/ELMS_3.0/managerChangePassword" method="post">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch('/ELMS_3.0/managerChangePassword', {
                    method: 'POST',
                    headers: {
               ...
               .then(data => {
				    ...
				    if (data.success) {
				        ...
				        if (data.redirect) {
				            ...
				            window.location.href = '/ELMS_3.0/Manager/ManagerSettings.jsp';
				        }
