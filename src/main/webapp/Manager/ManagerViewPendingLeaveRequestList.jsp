...
<head>
    ...
    <title>Pending Leave Requests - IMNSB Manager Portal</title>
    ...
    <style>
        ...
        /* Enhanced Modal Styles - Similar to Executive Director Page */
        .popup-overlay {
            position: fixed;
            top: 0;
            left: 0;
    ...
    <div class="dashboard-container">
        <!-- Manager Sidebar -->
		    ...
		    <ul class="sidebar-menu">
	            ...
	            <li><a href="/ELMS_3.0/Manager/ManagerSettings.jsp"><i class="fas fa-cog"></i> <span>Settings</span></a></li>
            ...
            <header class="content-header">
                ...
                <div class="header-right">
                    ...
                    <div class="user-avatar">
                        ...
                        %>
                        <img src="/ELMS_3.0/<%= headerProfilePicPath %>" alt="Manager Avatar" id="headerAvatar">
                        <% } else { %>
                        <img src="<%= request.getContextPath() %>/defaultprofilepicture.jpg" alt="Manager Avatar" id="headerAvatar">
                        <% } %>
                    </div>
                </div>
            </header>
                                    ...
                                    <div class="filter-group">
                                        ...
                                        <select id="leaveTypeFilter" name="leaveType">
                                            ...
                                            <c:forEach var="entry" items="${leaveTypeNames}">
                                                <option value="${entry.key}" ${param.leaveType == entry.key ? 'selected' : ''}>
                                                    ${entry.value}
                                                </option>
                                            </c:forEach>
                                        </select>
					        ...
					        <c:choose>
					            ...
					            <c:otherwise>
					                <div class="empty-state">
					                    ...
					                    <c:if test="${not empty param.leaveType or not empty param.employee or not empty param.priority or not empty param.applicationType or not empty param.fromDate or not empty param.toDate}">
...
<script>
    ...
    function viewLeaveDetails(applicationId) {
        ...
        // Show processing modal while loading
        showProcessingModal('Loading application details...');
        ...
        fetch('<%= request.getContextPath() %>/manager-leave-details?applicationId=' + applicationId)
            ...
            .catch(error => {
                ...
                showErrorModal('Error loading application details. Please try again.');
            });
    }
    ...
    function showApproveModal() {
        ...
        const message = `Are you sure you want to approve this leave application?`;
    ...
    function confirmApproval() {
        ...
        .then(data => {
            ...
            if (data.success) {
                closeModal();
                showSuccessModal('Leave application has been approved successfully!');
            } else {
    ...
    function confirmRejection() {
        ...
        .then(data => {
            ...
            if (data.success) {
                closeModal();
                showSuccessModal(`Leave application ${currentApplicationId} has been rejected.`);
            } else {
