    ...
    <div class="dashboard-container">
        ...
        <nav class="sidebar" id="sidebar">
            ...
            <ul class="sidebar-menu">
	            ...
	            <li><a href="<%= request.getContextPath() %>//executive-director-pending-requests"><i class="fas fa-clock"></i> <span>Pending Requests</span></a></li>
            ...
            <div class="content-body">
                <div class="settings-container">
                    <div class="settings-menu">
                        <a href="/ELMS_3.0/Manager/DirectorEditAccount.jsp" class="settings-item">
                        ...
                        <a href="DirectorChangePassword.jsp" class="settings-item">
                            <div class="settings-icon">
                        ...
                        <a href="DirectorDeleteAccount.jsp" class="settings-item danger" id="deleteAccountBtn">
                            <div class="settings-icon">
                                <i class="fas fa-user-times"></i>
                            </div>
                            <div class="settings-info">
                                <h3>Delete Account</h3>
                                <p>Permanently delete your Executive Director account and all data</p>
                            </div>
                            <i class="fas fa-chevron-right"></i>
                        </a>
                    </div>
    ...
    <div id="successPopup" class="popup-overlay">
        <div class="popup-content" style="max-width: 500px; border-top: 5px solid #28a745;">
            ...
            <div class="popup-footer">
                <button type="button" class="btn btn-success" onclick="closeSuccessPopup()">
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('✅ DirectorSettings.jsp loaded');

    // Add logout confirmation and feedback
    ...
    // Delete account button debugging
