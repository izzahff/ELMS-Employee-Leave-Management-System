...
/**
 * Admin servlet for downloading leave application attachments
 */
@WebServlet("/admin-file-download")
public class AdminFileDownloadServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("=== ADMIN FILE DOWNLOAD REQUEST ===");
        ...
        try {
            ...
            // Log admin access
            System.out.println("✅ Admin " + adminId + " accessing file: " + fileName + " for application: " + applicationId);
        ...
        System.out.println("=== ADMIN FILE DOWNLOAD COMPLETE ===");
    }
